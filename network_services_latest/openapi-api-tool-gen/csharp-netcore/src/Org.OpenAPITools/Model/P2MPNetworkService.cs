...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class P2MPNetworkService : P2MPNetworkServicePartial,  IEquatable<P2MPNetworkService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="P2MPNetworkService" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected P2MPNetworkService() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="P2MPNetworkService" /> class.
        /// </summary>
        ...
        /// <param name="name">Name of the point to multi-point virtual circuit. (required).</param>
        ...
        {
            return this.Equals(input as P2MPNetworkService);
        }

        /// <summary>
        /// Returns true if P2MPNetworkService instances are equal
        /// </summary>
        /// <param name="input">Instance of P2MPNetworkService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(P2MPNetworkService input)
        {
            if (input == null)
                return false;
