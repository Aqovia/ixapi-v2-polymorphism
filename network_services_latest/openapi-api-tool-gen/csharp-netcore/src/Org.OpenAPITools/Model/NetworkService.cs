...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(ExchangeLanNetworkService), "exchange_lan")]
    [JsonSubtypes.KnownSubType(typeof(MP2MPNetworkService), "mp2mp_vc")]
    [JsonSubtypes.KnownSubType(typeof(P2MPNetworkService), "p2mp_vc")]
    ...
    public partial class NetworkService :  IEquatable<NetworkService>, IValidatableObject
    {
        ...
        public NetworkService(string consumingAccount = default(string), string externalRef = default(string), string id = default(string), int? ixfdbIxid = default(int?), string managingAccount = default(string), string metroAreaNetwork = default(string), string name = default(string), List<string> networkFeatures = default(List<string>), int? peeringdbIxid = default(int?), string productOffering = default(string), StateEnum state = default(StateEnum), List<Status> status = default(List<Status>), string subnetV4 = default(string), string subnetV6 = default(string), string type = default(string), string billingAccount = default(string), int? capacity = default(int?), DateTime chargedUntil = default(DateTime), string contractRef = default(string), DateTime decommissionAt = default(DateTime), string joiningMemberAccount = default(string), string purchaseOrder = "", List<string> memberJoiningRules = default(List<string>), bool _public = false, string cloudKey = default(string), int diversity = default(int), string providerRef = default(string))
        {
            ...
            this.ConsumingAccount = consumingAccount ?? throw new ArgumentNullException("consumingAccount is a required property for NetworkService and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for NetworkService and cannot be null");
            // to ensure "managingAccount" is required (not null)
            this.ManagingAccount = managingAccount ?? throw new ArgumentNullException("managingAccount is a required property for NetworkService and cannot be null");
            // to ensure "metroAreaNetwork" is required (not null)
            this.MetroAreaNetwork = metroAreaNetwork ?? throw new ArgumentNullException("metroAreaNetwork is a required property for NetworkService and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for NetworkService and cannot be null");
            // to ensure "networkFeatures" is required (not null)
            this.NetworkFeatures = networkFeatures ?? throw new ArgumentNullException("networkFeatures is a required property for NetworkService and cannot be null");
            // to ensure "productOffering" is required (not null)
            this.ProductOffering = productOffering ?? throw new ArgumentNullException("productOffering is a required property for NetworkService and cannot be null");
            this.State = state;
            // to ensure "subnetV4" is required (not null)
            this.SubnetV4 = subnetV4 ?? throw new ArgumentNullException("subnetV4 is a required property for NetworkService and cannot be null");
            // to ensure "subnetV6" is required (not null)
            this.SubnetV6 = subnetV6 ?? throw new ArgumentNullException("subnetV6 is a required property for NetworkService and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for NetworkService and cannot be null");
            // to ensure "billingAccount" is required (not null)
            this.BillingAccount = billingAccount ?? throw new ArgumentNullException("billingAccount is a required property for NetworkService and cannot be null");
            // to ensure "joiningMemberAccount" is required (not null)
            this.JoiningMemberAccount = joiningMemberAccount ?? throw new ArgumentNullException("joiningMemberAccount is a required property for NetworkService and cannot be null");
            // to ensure "memberJoiningRules" is required (not null)
            this.MemberJoiningRules = memberJoiningRules ?? throw new ArgumentNullException("memberJoiningRules is a required property for NetworkService and cannot be null");
            // to ensure "cloudKey" is required (not null)
            this.CloudKey = cloudKey ?? throw new ArgumentNullException("cloudKey is a required property for NetworkService and cannot be null");
            this.Diversity = diversity;
            // to ensure "providerRef" is required (not null)
            this.ProviderRef = providerRef ?? throw new ArgumentNullException("providerRef is a required property for NetworkService and cannot be null");
