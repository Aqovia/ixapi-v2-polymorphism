...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(VLanConfigDot1QPartial), "dot1q")]
    [JsonSubtypes.KnownSubType(typeof(VLanConfigPortPartial), "port")]
    [JsonSubtypes.KnownSubType(typeof(VLanConfigQinQPartial), "qinq")]
    public partial class VlanConfigPartial :  IEquatable<VlanConfigPartial>, IValidatableObject
    {
        ...
        public VlanConfigPartial(int? vlan = default(int?), VlanEthertypeEnum? vlanEthertype = VlanEthertypeEnum._0x8100, string vlanType = default(string), int innerVlan = default(int), int? outerVlan = default(int?), OuterVlanEthertypeEnum? outerVlanEthertype = OuterVlanEthertypeEnum._0x8100)
        {
            // to ensure "vlanType" is required (not null)
            this.VlanType = vlanType ?? throw new ArgumentNullException("vlanType is a required property for VlanConfigPartial and cannot be null");
            this.Vlan = vlan;
