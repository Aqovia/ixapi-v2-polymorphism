...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MP2MPNetworkServicePartial :  IEquatable<MP2MPNetworkServicePartial>, IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MP2MPNetworkServicePartial" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MP2MPNetworkServicePartial() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MP2MPNetworkServicePartial" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MP2MPNetworkServicePartial);
        }

        /// <summary>
        /// Returns true if MP2MPNetworkServicePartial instances are equal
        /// </summary>
        /// <param name="input">Instance of MP2MPNetworkServicePartial to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MP2MPNetworkServicePartial input)
        {
            if (input == null)
                return false;
