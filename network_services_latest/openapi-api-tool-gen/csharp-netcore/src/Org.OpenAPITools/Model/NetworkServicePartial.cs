...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(CloudNetworkServicePartial), "cloud_vc")]
    [JsonSubtypes.KnownSubType(typeof(ExchangeLanNetworkServicePartial), "exchange_lan")]
    [JsonSubtypes.KnownSubType(typeof(MP2MPNetworkServicePartial), "mp2mp_vc")]
    [JsonSubtypes.KnownSubType(typeof(P2MPNetworkServicePartial), "p2mp_vc")]
    [JsonSubtypes.KnownSubType(typeof(P2PNetworkServicePartial), "p2p_vc")]
    public partial class NetworkServicePartial :  IEquatable<NetworkServicePartial>, IValidatableObject
    {
        ...
        public NetworkServicePartial(string consumingAccount = default(string), string externalRef = default(string), string id = default(string), int? ixfdbIxid = default(int?), string managingAccount = default(string), string metroAreaNetwork = default(string), string name = default(string), List<string> networkFeatures = default(List<string>), int? peeringdbIxid = default(int?), string productOffering = default(string), StateEnum? state = default(StateEnum?), List<Status> status = default(List<Status>), string subnetV4 = default(string), string subnetV6 = default(string), string type = default(string), string billingAccount = default(string), int? capacity = default(int?), DateTime chargedUntil = default(DateTime), string contractRef = default(string), DateTime decommissionAt = default(DateTime), string joiningMemberAccount = default(string), string purchaseOrder = "", List<string> memberJoiningRules = default(List<string>), bool _public = false, string cloudKey = default(string), int diversity = default(int), string providerRef = default(string))
        {
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for NetworkServicePartial and cannot be null");
