...
class VlanConfig(object):
    ...
    discriminator_value_class_map = {
            'dot1q'.lower(): '#/components/schemas/VLanConfigDot1Q',
            'port'.lower(): '#/components/schemas/VLanConfigPort',
            'qinq'.lower(): '#/components/schemas/VLanConfigQinQ',
    }

    def __init__(self):  # noqa: E501
        """VlanConfig - a model defined in Swagger"""  # noqa: E501
