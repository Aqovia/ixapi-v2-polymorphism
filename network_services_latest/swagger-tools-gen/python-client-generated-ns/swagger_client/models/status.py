...
import six
from swagger_client.models.status_partial import StatusPartial  # noqa: F401,E501

class Status(StatusPartial):
    ...
    if hasattr(StatusPartial, "swagger_types"):
        swagger_types.update(StatusPartial.swagger_types)

    attribute_map = {
    }
    if hasattr(StatusPartial, "attribute_map"):
        attribute_map.update(StatusPartial.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """Status - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        StatusPartial.__init__(self, *args, **kwargs)
