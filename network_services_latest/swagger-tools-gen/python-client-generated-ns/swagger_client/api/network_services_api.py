...
class NetworkServicesApi(object):
    ...
    def network_services_list(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.network_services_list_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def network_services_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'state', 'state__is_not', 'managing_account', 'consuming_account', 'external_ref', 'type', 'pop', 'product_offering']  # noqa: E501
        ...
        if 'state__is_not' in params:
            query_params.append(('state__is_not', params['state__is_not']))  # noqa: E501
        if 'managing_account' in params:
            query_params.append(('managing_account', params['managing_account']))  # noqa: E501
        if 'consuming_account' in params:
            query_params.append(('consuming_account', params['consuming_account']))  # noqa: E501
        if 'external_ref' in params:
            query_params.append(('external_ref', params['external_ref']))  # noqa: E501
        if 'type' in params:
            query_params.append(('type', params['type']))  # noqa: E501
        if 'pop' in params:
            query_params.append(('pop', params['pop']))  # noqa: E501
        if 'product_offering' in params:
            query_params.append(('product_offering', params['product_offering']))  # noqa: E501
